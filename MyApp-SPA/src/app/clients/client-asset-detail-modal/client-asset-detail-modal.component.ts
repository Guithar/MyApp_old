...
@Component({
  selector: 'app-client-asset-detail-modal',
  templateUrl: './client-asset-detail-modal.component.html',
  styleUrls: ['./client-asset-detail-modal.component.css']
})
export class ClientAssetDetailModalComponent implements OnInit {
  action: string;
  Categories: ProductCategory[];
  ListOfProducts: Product[];
  productParams: any = {};

  constructor(public dialogRef: MatDialogRef<ClientAssetDetailModalComponent>,
